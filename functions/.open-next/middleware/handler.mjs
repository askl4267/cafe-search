...
async function awaitAllDetachedPromise() {
  ...
  const promisesToAwait = store?.pendingPromiseRunner.awaitAll() ?? Promise.resolve();
  if (store?.waitUntil) {
